...
export function createDefineEnv({ allowedRevalidateHeaderKeys, clientRouterFilters, config, dev, distDir, fetchCacheKeyPrefix, hasRewrites, middlewareMatchers, previewModeId }) {
    let defineEnv = {
        client: [],
        edge: [],
        nodejs: []
